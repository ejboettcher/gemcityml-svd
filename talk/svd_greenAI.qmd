...
Solving a  system of linear equations is fast. <br>

It can easily handle, quickly large data. <br>
...
Beyond solving a system of linear equations. <br>
It is used for:
...
So when we have the equation system `Ax=b`
...
There exists a data of the number of sun spots observed over a month, spanning hundred of years.
<br>
